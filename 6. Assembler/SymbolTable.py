...
class SymbolTable:
    ...
    def __init__(self) -> None:
        """Creates a new symbol table initialized with all
           the predefined symbols and their pre-allocated RAM addresses,
           according to section 6.2.3 of the book.
        """

        self.symbol_table = {"SP": 0, "R0": 0, "LCL": 1, "R1": 1, "ARG": 2,
                             "R2": 2, "THIS": 3, "R3": 3, "THAT": 4, "R4": 4,
